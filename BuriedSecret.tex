...
\chapter{Playtesty}
  ...
  informacji zwrotnej od~nowych testerów, nieznających koncepcji gry.
	...
	\item ankieta z~pytaniami do~testera.
      ...
      \subsection{Wnioski}
%       mechanika budynków
%       brak użycia konstrukcji
%       interfejs jednostki (otwarcie i używanie)
%       wymiana ekwipunku z bazą
%       wyszukiwanie ścieżek
%       przenoszenie obozu
%       trudność z rozkminieniem psychozy
	...
	\item ankieta z~pytaniami do~testera.
      ...
      \subsection{Wnioski}
%       udało się wyeliminować poprzednie błędy
%       kolejna iteracja uwag odnośnie interfejsu
%       konstrukcje potrafią być przydatne, potencjał
%       konstruowanie przedmiotów nadal mało przydatne
%       interfejs wymiany ekwipunku z bazą
%       interfejs wydawania poleceń
%       potrzebna pomoc - pomysł z pomocą jako overlay
