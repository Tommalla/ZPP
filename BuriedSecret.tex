...
%   Analiza dlaczego te a nie inne (może tu, może dla każdej biblioteki porównanie z konkurencją)
    ...
    Qt posiada również komponenty do tworzenia graficznego interfejsu, co wykorzystaliśmy w module $UserInterface$.
...
% tutaj dane, formaty, diagram klas, algorytmy, moduły
  ...
  \section{Moduł ``Game Objects''}
    \subsection{Ogólny opis modułu}
      ...
      mapie, jak i wszelkiego rodzaju wpisy w dzienniku, zadania, itd. W skład $GameObjects$ wchodzą klasy
