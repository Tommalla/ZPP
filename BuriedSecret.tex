...
\begin{thebibliography}{99}
  ...
  \bibitem[Progry]{PROGRY} Strona internetowa Koła Programowania Gier Komputerowych, \url{http://progry.mimuw.edu.pl}
  \bibitem[GamesMarket]{CA} O przemyśle gier komputerowych, \url{https://www.superdataresearch.com/blog/global-games-market-2015/}
  \bibitem[Commandos]{CBEL} ,,Commandos: Behind Enemy Lines." Wikipedia: The Free Encyclopedia, \url{https://en.wikipedia.org/wiki/Commandos:_Behind_Enemy_Lines}
  \bibitem[FalloutTactics]{FT} Fallout Tactics: Brotherhood of Steel, \url{http://fallout.gamepedia.com/Fallout_Tactics:_Brotherhood_of_Steel}
  \bibitem[GaussianBlur]{GB} ,,Gaussian blur." Wikipedia: The Free Encyclopedia, \url{http://en.wikipedia.org/wiki/Gaussian_blur}
  \bibitem[A*]{A*} ,,A* search algorithm." Wikipedia: The Free Encyclopedia, \url{http://en.wikipedia.org/wiki/A*_search_algorithm}
  \bibitem[HPA]{HPA} BOTEA, Adi; MÜLLER, Martin; SCHAEFFER, Jonathan. Near optimal hierarchical path-finding. Journal of game development, 2004, 1.1: 7-28.
  \bibitem[Qt]{QT} Dokumentacja techniczna Qt, \url{http://doc.qt.io/qt-5/reference-overview.html}
  \bibitem[SFML]{SFML} Dokumentacja techniczna SFML, \url{http://www.sfml-dev.org/documentation/2.3/}
  \bibitem[Box2D]{BOX} Dokumentacja techniczna Box2d, \url{http://box2d.org/documentation/}
  \bibitem[Fabuła]{SDD} O tworzeniu fabuły, \url{http://www.gamasutra.com/blogs/DanielBiesiada/20100210/86632/Storydriven_design__Way_of_a_Hero.php}
  \bibitem[Wzorce]{PATTERNS} Wzorce projektowe dla gier komputerowych, \url{http://gameprogrammingpatterns.com/}
  \bibitem[Playtesty]{PLAYTESTY} O czym warto pamiętać, przy przeprowadzaniu playtestów, \url{http://www.joramwolters.com/playtesting-preparation-and-execution/}
